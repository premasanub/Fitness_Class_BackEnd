...
export const forgotPassword = async (req, res) => {
  try {
    ...
    console.log("1. Forgot password request:", email);
    ...
    // Reset URL
    const resetUrl = `https://fitness-class-front-end-hb3y-ms914zjct-premas-projects.vercel.app/reset-password/${user._id}/${token}`;

    console.log("4. Sending reset email...");
